...
class ExperimentPlanner3D_FLARE22Small(ExperimentPlanner):
    """
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_FLARE22Small, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_FLARE22Small"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansFLARE22Small_plans_3D.pkl")
